...
function buildItems(settings, shopSlug) {
  ...
  return [
    ...
    },
    {
      ...
      description:
        "From Shopify admin, go to Online Store → Themes → Customize → App embeds and enable Observa, then Save.",
      image: {
        url: "https://cdn.shopify.com/b/shopify-guidance-dashboard-public/nqjyaxwdnkg722ml73r6dmci3cpn.svgz",
        alt: "Theme app embed enable",
      },
      complete: false,
      primaryButton: {
    ...
    {
      id: 2,
      title: "Send a Test Slack Notification",
      description:
        "Verify your Slack integration by sending a test alert from the Settings page.",
      image: {
      ...
      complete: false,
      primaryButton: {
        content: "Go to Settings → Test Alerts",
        props: {
          url: "/app/settings",
        },
      },
